...
// YouTube TAGS pure helpers live in a client-safe sibling so React
// components (the bulk-batch inspector + ShortSeoResults) can import
// the budget-math without pulling next/headers into the browser bundle.
// Re-exported here so existing server callers + tests keep their import
// path stable.
export {
  ...
  YT_MAX_TAGS,
  YT_MAX_TAG_LENGTH,
  YT_MAX_COMBINED_LENGTH,
} from './shorts-seo-tags';
import { normaliseYoutubeTags } from './shorts-seo-tags';
