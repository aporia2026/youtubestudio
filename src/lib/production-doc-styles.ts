...
export const BUILT_IN_STYLES: readonly ResolvedStyle[] = Object.freeze([
   ...
   */
  {
    ...
    ai_image_suffix:
      'extremely minimalist stick figure cartoon in the style of a child\'s freehand drawing, thin uneven hand-drawn black ink lines on plain pure white background, asdfmovie / Cyanide & Happiness aesthetic. CHARACTERS: head is an empty circle outline with WHITE INTERIOR (no fill color, never yellow, never tinted), two small black dots for eyes (or two small black rectangles for glasses), tiny optional mouth as a dot or short curve, arms and legs are thin single-stroke lines that END IN A CLEAN LINE TERMINATION like a pencil stroke that stops — NO defined hands, NO fingers, NO knuckles, NO fists, NO mittens, NO little curves at the tip, NO hand-shapes of any kind, the arm is JUST A LINE that ends. ONLY EXCEPTION: when the action absolutely requires gripping something specific (typing on a keyboard, holding a tool, pointing a finger at a small object the hand must touch), draw the simplest possible nub — never anatomically defined. For waving, pointing at the air, walking, standing, gesturing, expressing emotion, or holding nothing: the arm MUST end in just a line. LINES are wobbly, imperfect, slightly wonky, freehand, NOT clean vector, NOT polished, NOT smooth. NO shading, NO gradients, NO drop shadows. Pure black ink only on the figure itself. Color (a single saturated red, or a pale blue / pale yellow / light gray fill) appears ONLY on specific scene props like a red skull, a blue book cover, a yellow building — NEVER on the character\'s body or head. NOT photorealistic, NOT 3D, NOT a photograph, NOT anime, NOT manga.',
    built_in_refs: [
