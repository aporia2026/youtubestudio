...
export const BUILT_IN_STYLES: readonly ResolvedStyle[] = Object.freeze([
   ...
   */
  {
    ...
    mixing_rules: [
      ...
      '',
      'HARD MINIMUM: ~30% of all narrative rows MUST be motion_collage. For a 24-row doc, that means 7-9 motion_collage rows minimum. A doc with fewer than 5 motion_collage rows on a typical script is broken — go back and find more.',
      '',
      ...
      '',
      'SELF-CHECK BEFORE SUBMITTING: Count your motion_collage rows. If the count is below 30% of total narrative rows, go BACK and find motion you missed. The script ALWAYS has more motion than your first pass identified. Re-read every row asking "what changes in this beat?" — if anything changes, it\'s motion_collage.',
      '',
      ...
      '  - 15-25 rows: aim for 4-7 motion_collage shots (~25-35% of rows)',
      '  - 26-40 rows: aim for 8-14 motion_collage shots (~30-35% of rows)',
      '  - 41+ rows: aim for ~30% of rows being motion_collage',
      '',
