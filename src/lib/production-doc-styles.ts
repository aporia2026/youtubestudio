...
export const BUILT_IN_STYLES: readonly ResolvedStyle[] = Object.freeze([
   ...
   */
  {
    ...
    mixing_rules: [
      ...
      '',
      'GRID SIZE: default to 2×2 (4 panels). Larger grids (3×3 = 9 panels, 4×3 = 12) push the chained-Edit pipeline past Vercel\'s 300-second function budget — every panel chains sequentially and a 9-panel collage on the slower Kie vendor takes ~10 minutes, blowing the timeout. 2×2 keeps every regen inside the budget on both vendors. The MOTION DELTA rules below still apply: spread the motion across the 4 panels with the smallest credible per-step deltas, accepting that the final panel may only show the motion almost complete.',
      '',
