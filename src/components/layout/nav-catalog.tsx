...
export const HUBS: NavHub[] = [
  {
    ...
    items: [
      ...
      {
        label: 'Clone Templates',
        href: '/channel-clone/templates',
        hint: 'Saved channel-clone presets — re-spin runs without re-upload',
        keywords: ['clone', 'template', 'preset', 'saved', 'channel', 'reuse'],
        tier: 'secondary',
        icon: (
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M4 4h16v4H4z" />
