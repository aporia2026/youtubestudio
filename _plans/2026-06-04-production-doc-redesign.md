...
- **Phase R3 — Inspector tab expansion (2–3 PRs).** Move every today-column control into the Inspector's tabbed structure. This is the biggest UI change. Granular PRs by tab (Content, Image, Video, Overlay, Section, Variants).
